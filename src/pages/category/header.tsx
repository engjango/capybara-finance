...
export const CategoryPageHeader: React.FC = () => {
    ...
    const redirect = (id: ID) => () =>
        CapybaraDispatch(AppSlice.actions.setPageState({ ...DefaultPages.category, category: id }));
    ...
    return (
        <Section>
            <ContainerBox>
                ...
                <ShoppingBasketIcon sx={{ background: colour }} htmlColor="#fff" />
                <ValuesBox>
                    <CategoryBreadcrumbs>
                ...
                <EditIconButton onClick={openEditView} size="large" style={{border: "1px solid #fff"}}>
                    <Edit htmlColor='#fff' />
                </EditIconButton>
            </ContainerBox>
        </Section>
...
const DatesTypography = styled(Typography)({ color: "#67656a", lineHeight: 1 });
