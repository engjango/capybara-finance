        ...
        <ContainerCard>
            <ButtonBase sx={TopLevelSx} onClick={onClick} component="div">
                ...
                <MainBox>
                    ...
                    <CategoriesTableActionBox>
                        <IconButton size="small" onClick={openEditView} style={{color: "#fff"}}>
                            <Edit />
                        </IconButton>
                    </CategoriesTableActionBox>
                </MainBox>
...
const BlueTextSx = { color: "#67656a", lineHeight: 1 };
const GreenTextSx = { color: "green", lineHeight: 1 };
const RedTextSx = { color: "red", lineHeight: 1 };
const BudgetTypography = styled(Typography)({ color: "#67656a", marginLeft: 5 });
