        ...
        <DialogMain onClick={remove}>
            ...
            <DialogContents>
                {working ? (
                    ...
                    <NonIdealState
                        icon={AccountBalance}
                        title={translations[language].institutions}
                        subtitle={translations[language].institutionsDesc}
                    />
...
export const createNewInstitution = (): Institution => ({
    id: getNextID(CapybaraStore.getState().data.institution.ids),
...
const EditInstitutionView: React.FC = () => {
    ...
    return (
        <ObjectEditContainer type="institution">
            <EditValueContainer label={translations[language].icon}>
            ...
            <EditValueContainer label={translations[language].color}>
                <ColourContainerBox>
                    ...
                    <IconButton size="small" onClick={refreshColourFromIcon}>
                        <Tooltip
                            title={
                                working.icon
                                    ? translations[language].refreshColorFromIcon
                                    : translations[language].getRandomColor
                            }
                        >
                            <Sync />
                        </Tooltip>
...
const refreshColourFromIcon = () => {
    const { colour, icon } = CapybaraStore.getState().app.dialog.institution!;
