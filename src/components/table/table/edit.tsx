      ...
      (onClick: () => void) => {
         return (
            <SingleCategoryMenu
               ...
               anchor={fixed?.type === 'category' && fixed.nested ? { id: fixed.category, include: true } : undefined}
            />
         );
      },
   ...
   return (
      <>
            ...
            <ManagedDatePicker
               ...
               slotProps={{
                  textField: {
                     ...
                     inputProps: {
                        placeholder:
                           tx && tx.date === undefined ? translations[language].mixed : translations[language].unset,
                     },
                     sx: {
         ...
         {fixed?.type !== 'category' || fixed.nested === true ? (
            <TransactionTableCategoryContainer>
               <Tooltip title={edit.value === null ? translations[language].transactionHasNoValue : ''}>
                  <CategoryWrapperSpan>
         ...
         <ActionsBox>
            <Tooltip title={ translations[language].saveChanges }>
               <span>
                  <IconButton size="small" onClick={tx ? actions.save : actions.create} style={{padding: "8px", background: "#080707"}}>
                     <SaveTwoTone
                        fontSize="small"
            ...
            <Tooltip title={ translations[language].discardChanges }>
               <IconButton size="small" onClick={updaters.discard} style={{padding: "8px", background: "#080707"}}>
                  <DeleteTwoTone fontSize="small" htmlColor={Intents.warning.main} />
               </IconButton>
            </Tooltip>
            {tx && (
               <Tooltip title={ translations[language].removeTransaction }>
      ...
      () => ({
         create: () =>
            batch(() => {
               ...
               CapybaraDispatch(DataSlice.actions.addNewTransaction(edit as Transaction));
            }),
         save: () =>
            batch(() => {
               setStatePartial({ edit: undefined });
         ...
         delete: () =>
            batch(() => {
               ...
               CapybaraDispatch(DataSlice.actions.deleteTransactions(edit.id === undefined ? selected : [edit.id]));
            }),
      }),
