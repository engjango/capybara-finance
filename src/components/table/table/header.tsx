...
export const TransactionsTableHeader: React.FC<TransactionsTableHeaderProps> = ({
    ...
    return (
        <>
            <TransactionTableDateContainer>
                <TransactionTableCompoundContainer>
                    ...
                    <Popover {...DateRangePopoverState.popoverProps} PaperProps={PopoverPaperProps}>
                        <SubHeader name={ translations[language].startDate }>
                            <ManagedDatePicker
                        ...
                        <SubHeader name={ translations[language].endDate }>
                            <ManagedDatePicker
            ...
            <TextBox>
                <TransactionTableCompoundContainer>
                    ...
                    <Popover {...DescriptionPopoverState.popoverProps} PaperProps={PopoverPaperProps}>
                        <SubHeader name={ translations[language].search }>
                            <UnmountableTextField
                                size="small"
                                label={ translations[language].searchTerm }
                        ...
                        <SubItemCheckbox
                            label={ translations[language].regexSearch }
            ...
            <TransactionTableValueContainer>
                <TransactionTableCompoundContainer>
                    ...
                    <Popover {...ValuePopoverState.popoverProps} PaperProps={PopoverPaperProps}>
                        <SubHeader name={ translations[language].valuesFrom }>
                            <TextField
                        ...
                        <SubHeader name={ translations[language].valuesTo }>
                            <TextField
                        ...
                        <SubItemCheckbox
                            label={ translations[language].hideStubs }
            ...
            <TransactionTableStatementContainer>
                ...
                <Menu {...StatementPopoverState.popoverProps} PaperProps={{ style: { maxHeight: 250, width: 300 } }}>
                    {statements.length ? (
                        ...
                        <NonIdealState icon={Description} title={ translations[language].noStatements } intent="app" />
                    )}
                </Menu>
            </TransactionTableStatementContainer>
            {fixed?.type !== "account" ? (
            ...
            <TransactionTableActionsContainer>
                <IconButton size="small" onClick={createNewTransaction} disabled={!canCreateNew} style={{ color: "#fff"}}>
                    <AddCircleOutline />
                </IconButton>
            </TransactionTableActionsContainer>
        </>
...
export const getNewTransaction = (): Transaction => {
    const { data } = CapybaraStore.getState();
    ...
    useCallback(() => {
        ...
        if (fixed?.type === "account") {
            ...
            transaction.currency = Number(
                keys(CapybaraStore.getState().data.account.entities[fixed.account]!.balances)[0] ?? transaction.currency
            );
        }
